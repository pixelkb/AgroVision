      ...
      <div className="max-w-lg w-full space-y-10 bg-white/90 backdrop-blur-md rounded-3xl p-10 border-2 border-gray-200/50 shadow-2xl hover:shadow-3xl hover:border-agri-300 transform hover:scale-105 transition-all duration-500">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            <div>
              <label htmlFor="name" className="block text-lg font-bold text-soil-700 mb-3 font-display hover:text-agri-700 transition-colors duration-300">
                {t('auth.name')}
              </label>
              <input
                id="name"
            ...
            <div>
              <label htmlFor="phone" className="block text-lg font-bold text-soil-700 mb-3 font-display hover:text-agri-700 transition-colors duration-300">
                {t('auth.phone')}
              </label>
              <input
                id="phone"
            ...
            <div>
              <label htmlFor="language" className="block text-lg font-bold text-soil-700 mb-3 font-display hover:text-agri-700 transition-colors duration-300">
                {t('auth.language')}
              </label>
              <select
                id="language"
                ...
                className="appearance-none relative block w-full px-6 py-4 border-2 border-gray-200 text-lg text-gray-900 rounded-2xl focus:outline-none focus:ring-4 focus:ring-agri-300 focus:border-agri-500 hover:border-agri-400 hover:bg-white transition-all duration-300 font-medium bg-white/80 backdrop-blur-sm cursor-pointer shadow-sm hover:shadow-md"
              >
