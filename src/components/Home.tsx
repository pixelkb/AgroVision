    ...
    <div className="min-h-screen bg-agri-gradient bg-field-texture">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center">
          ...
          <p className="text-xl md:text-2xl text-soil-700 mb-8 max-w-4xl mx-auto">
            {t('home.subtitle')}
          </p>
          <button
            onClick={handleGetStarted}
            className="inline-flex items-center px-8 py-4 border border-transparent text-lg font-medium rounded-xl text-white bg-agri-600 hover:bg-agri-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-agri-500 shadow-leaf hover:shadow-xl transform hover:scale-105 transition-all duration-200"
          >
      ...
      <div className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="bg-gradient-to-r from-agri-600 via-crop-500 to-agri-700 text-white rounded-2xl p-8 max-w-2xl mx-auto shadow-leaf">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-crop-100 rounded-2xl flex items-center justify-center mx-auto mb-6">
                <Brain className="w-8 h-8 text-crop-700" />
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-4">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-agri-100 rounded-2xl flex items-center justify-center mx-auto mb-6">
                <Stethoscope className="w-8 h-8 text-agri-700" />
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              <div className="w-12 h-12 bg-agri-100 rounded-xl flex items-center justify-center mb-6">
                <TrendingUp className="w-6 h-6 text-agri-700" />
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-4">
                Accurate Detection
              </h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              <div className="w-12 h-12 bg-crop-100 rounded-xl flex items-center justify-center mb-6">
                <Users className="w-6 h-6 text-crop-700" />
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-4">
                Farmer-Friendly
              </h3>
